...
export const searchProjects = (keyword) => async (dispatch) => {
  ...
  try {
    ...
    console.log("error", error);
    dispatch({ type: SEARCH_PROJECT_FAILURE, error });
  }
};
...
export const fetchProjectById = (id) => async (dispatch) => {
  ...
  try {
    ...
    console.log("error", error);
    dispatch({ type: FETCH_PROJECT_BY_ID_FAILURE, error });
  }
};
...
export const deleteProject =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("error", error);
      dispatch({ type: DELETE_PROJECT_FAILURE, error });
    }
  };
...
export const acceptInvitation =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("error", error);
      dispatch({ type: ACCEPT_INVITATION_FAILURE, error });
    }
  };
